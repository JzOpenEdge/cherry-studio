...
(`runtime/aiSdk/params/feature.ts`):
...
in `runtime/aiSdk/params/features/index.ts`:
...
- Tests: `runtime/aiSdk/params/__tests__/` (`assembleSystemPrompt`,
  `collectFromFeatures`, `composeHooks`),
  `runtime/aiSdk/params/features/__tests__/`
